...
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 105934848 # This is the maximum known partition size, but it can be higher, so we just omit it
...
TARGET_KERNEL_SOURCE := kernel/realme/RE546F
TARGET_KERNEL_CONFIG := RE546F_defconfig
